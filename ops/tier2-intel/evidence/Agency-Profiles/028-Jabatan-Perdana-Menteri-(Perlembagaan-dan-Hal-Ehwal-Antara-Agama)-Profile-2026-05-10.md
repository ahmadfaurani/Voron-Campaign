---
**Agency:** Jabatan Perdana Menteri (Perlembagaan dan Hal Ehwal Antara Agama)
**Profile ID:** TIER2-028-20260510
**Type:** Federal
**Collection Date:** 2026-05-10 15:48 UTC
...
|-------|-------|------------|
| **Full Name** | Jabatan Perdana Menteri (Perlembagaan dan Hal Ehwal Antara Agama) | High |
| **Type** | Federal | High |
| **Mandate** | [Pending OSINT enrichment] | Low |
| **Website** | [Pending OSINT] | Low |
| **HQ Address** | [Pending OSINT] | Low |

**Strategic Importance:**  Priority — Tier C
...
|-----------|--------|---------|------------|
| **Recent Breach (12 months)** |  |  | Medium |
| **Nation-State Targeting** | Medium | Government agency = potential target | Medium |
| **Sector Threat Level** | Medium | Federal sector | Medium |
| **MyCERT Incidents** | [Pending correlation] | [Pending] | Low |
| **NACSA Investigation** | [Pending correlation] | [Pending] | Low |
| **Compliance Deadlines** |  | Standard federal agency | Medium |
| **Digital Transformation Projects** |  | Public sector digitalization | Medium |

**Threat Score:** 50/100 (automated preliminary)
...
| **Budget Cycle** |  | Federal fiscal year | Medium |
...
**Budget Score:** 50/100 (automated preliminary)
...
| **Threat Urgency** | 35% | 50 | 17.5 |
| **Budget Readiness** | 30% | 50 | 15.0 |
| **SUBTOTAL** | 70% | — | **32.5 / 70** |
| **Relationship (Est.)** | 35% | 50 (estimated — pending validation) | 17.5 |
| **TOTAL (Estimated)** | 100% | — | **50.0 / 100** |

**Tier Classification:**  (preliminary — will be recalculated after CSM/Aras data)  
**Priority Rank:** #28 of 100 (preliminary)
...
| 35 | [Various] | 2026-05-10 | 35 | Medium |
...
|--------|-----------|-----------|--------|
| **Profile Created** | 2026-05-10 15:48 UTC | HOI-Agent (Batch) | ✅ Complete |
| **Leadership Extracted** | ⏳ Pending | HOI-Agent | ⏳ Queued |
| **Threat Intel Correlated** | 2026-05-10 15:48 UTC | HOI-Agent (Batch) | ✅ Complete (preliminary) |
| **Budget Analysis** | ⏳ Pending | HOI-Agent | ⏳ Queued |
| **CSM Validation** | ⏳ Pending | Zaharudin | ⏳ Awaiting |
| **Final Review** | ⏳ Pending | HOI-Agent | ⏳ Pending |

**Storage Path:** `/home/p62operator/.openclaw/workspace-hoi/ops/tier2-intel/evidence/Agency-Profiles/028-Jabatan-Perdana-Menteri-(Perlembagaan-dan-Hal-Ehwal-Antara-Agama)-Profile-2026-05-10.md`  
**Evidence ID:** TIER2-AGY-028  
...
**Last Updated:** 2026-05-10 15:48 UTC  
