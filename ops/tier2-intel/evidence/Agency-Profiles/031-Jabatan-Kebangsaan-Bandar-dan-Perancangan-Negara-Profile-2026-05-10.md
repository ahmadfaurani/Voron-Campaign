---
**Agency:** Jabatan Kebangsaan Bandar dan Perancangan Negara
**Profile ID:** TIER2-031-20260510
**Type:** Federal
**Collection Date:** 2026-05-10 16:06 UTC
...
|-------|-------|------------|
| **Full Name** | Jabatan Kebangsaan Bandar dan Perancangan Negara | High |
| **Type** | Federal | High |
...
**Priority Rank:** #31 of 100 (preliminary)
...
|--------|-----------|-----------|--------|
| **Profile Created** | 2026-05-10 16:06 UTC | HOI-Agent (Batch) | ✅ Complete |
| **Leadership Extracted** | ⏳ Pending | HOI-Agent | ⏳ Queued |
| **Threat Intel Correlated** | 2026-05-10 16:06 UTC | HOI-Agent (Batch) | ✅ Complete (preliminary) |
| **Budget Analysis** | ⏳ Pending | HOI-Agent | ⏳ Queued |
| **CSM Validation** | ⏳ Pending | Zaharudin | ⏳ Awaiting |
| **Final Review** | ⏳ Pending | HOI-Agent | ⏳ Pending |

**Storage Path:** `/home/p62operator/.openclaw/workspace-hoi/ops/tier2-intel/evidence/Agency-Profiles/031-Jabatan-Kebangsaan-Bandar-dan-Perancangan-Negara-Profile-2026-05-10.md`  
**Evidence ID:** TIER2-AGY-031  
...
**Last Updated:** 2026-05-10 16:06 UTC  
