...
Analyzes sentiment for entities from extraction cycle 20260702T060111Z
...
# Configuration
ENTITIES_FILE = "/home/p62operator/.openclaw/workspace-hoi/intelligence/entities/entities_20260702T060111Z.json"
...
def generate_report(data, entity_sentiments, coalition_aggregates, anomalies):
...
def main():
    ...
    # Generate report
    report, timestamp = generate_report(data, entity_sentiments, coalition_aggregates, anomalies)
    ...
    json_output = {
        'timestamp': timestamp,
        'source_file': 'entities_20260702T060111Z.json',
